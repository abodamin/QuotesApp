...
import 'dart:math';
import 'dart:ui';
import 'package:QuatesApp/App/colors.dart';
...
Widget buttonText(String txt, [BuildContext context]) {
  return Ink(
    ...
    child: Container(
      ...
      child: Text(
        ...
        style: TextStyle(
            color: Colors.white,
            fontSize: context != null ? get16Size(context) : 16),
      ),
    ),
  );
}
...
//just swap input
Widget buttonTextGreen2(String txt, BuildContext context) {
  return Ink(
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [greenColor, greenColor],
